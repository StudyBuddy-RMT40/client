...
export function updateStatusProject(id, status) {
    return async () => {
        try {
            const access_token = await AsyncStorage.getItem("access_token")
            const { data } = await axios.patch(`${BASE_URL}/projects/${id}`, { status }, {
                headers: {
                    access_token
                }
            })
...
export function addSpecialist(specialist) {
    return async () => {
        try {
            const access_token = await AsyncStorage.getItem("access_token")
            const { data } = await axios.post(`${BASE_URL}/specialist`, { specialist }, {
                headers: {
                    access_token
                }
            })
...
export function addLike(projectId) {
    return async () => {
        try {
            const access_token = await AsyncStorage.getItem("access_token")
            const { data } = await axios.post(`${BASE_URL}/likes`, { projectId }, {
                headers: {
                    access_token
                }
            })
...
export function deleteLike(projectId) {
    return async () => {
        try {
            const access_token = await AsyncStorage.getItem("access_token")
            const { data } = await axios.delete(`${BASE_URL}/likes`, { projectId }, {
                headers: {
                    access_token
                }
            })
